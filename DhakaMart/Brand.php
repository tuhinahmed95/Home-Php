    ...
    <div class="modal-box " style="max-width:800px;">
        <form method="post" action="ViewCode.php">
            ...
            <div class="modal-action modal_btn">
                ...
                <button class="btn" type="submit" name="add_brand">ADD</button>
            </div>
...
<div class="flex gap-3 items-center justify-center my-5">
    ...
    <h1 class="text-center font-bold text-2xl">Brand Table</h1>
    <div class="border-t flex-grow "></div>
</div>
<!-- Add Product -->
<div class="flex justify-end my-4">
    <button class="btn btn-md btn-secondary view-details " onclick="my_modal_1.showModal()">
        <i class="fa-regular fa-square-plus"></i> Add Brand
    </button>
</div>
<!-- Products Table -->
<div class="">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="tooltip" data-tip="Edit">
                                ...
                                <a href="BrandEdit.php?id=<?php echo $row["id"] ?>"><i style="color:green; font-size:20px;" class="fa-regular fa-pen-to-square"></i></a>

                            </div>
                            <!-- Delete Button -->
                            <div class="tooltip" data-tip="Delete">
                                <form action="ViewCode.php" method="post">
                                    <button type="submit" name="delete_brand" value="<?php echo $row['id'] ?>"><i style="color:red; font-size:20px;" class="fa-regular fa-trash-can"></i></button>
                                </form>
                            </div>
                            <!-- View details button -->
